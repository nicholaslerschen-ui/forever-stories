...
// API Configuration
const API_URL = import.meta.env.VITE_API_URL || 'http://192.168.0.22:3001';
...
export default function LegacyApp() {
  ...
  const renderIntake = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 p-4 sm:p-6 py-8 sm:py-12">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Tell Us About Yourself</h2>
            <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">This helps us personalize your experience and create meaningful prompts</p>
  ...
  const renderDailyPrompt = () => (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 p-3 sm:p-4 py-6 sm:py-12">
          ...
          <div className="flex items-center justify-around">
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 sm:gap-2 mb-1">
                ...
                <span className="text-xl sm:text-2xl font-bold text-gray-900">{userStats.currentStreak}</span>
              </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 sm:gap-2 mb-1">
                ...
                <span className="text-xl sm:text-2xl font-bold text-gray-900">{userStats.totalResponses}</span>
              </div>
              <p className="text-xs sm:text-sm text-gray-600">Stories</p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-8 mb-4 sm:mb-6">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <button
              onClick={logout}
              className="text-gray-600 hover:text-gray-900 text-xs sm:text-sm underline whitespace-nowrap ml-2"
            >
              Logout
            </button>
          </div>
          ...
          {!promptAnswered ? (
            <div>
              <p className="text-gray-600 mb-4">
                Share your story and keep your streak alive!
              </p>
              <button
                onClick={() => {
