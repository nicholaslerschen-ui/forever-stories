...
export default function LegacyApp() {
  ...
  const loadTodayPrompt = async () => {
    try {
      const data = await apiCall('/api/prompts/today');
      if (data.answered) {
        setPromptAnswered(true);
        setPromptResponse(data.response.response);
      } else {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="bg-gradient-to-br from-rose-500 to-orange-500 p-3 rounded-xl">
                <BookOpen className="w-6 h-6 text-white" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Today's Prompt</h2>
          ...
          {!promptAnswered ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                You've completed today's prompt. Come back tomorrow for a new question!
              </p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-6">
              <BookOpen className="w-10 h-10 text-rose-500 mb-3" />
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-rose-600 to-orange-500 text-white py-4 rounded-xl font-semibold hover:from-rose-700 hover:to-orange-600 transition-all flex items-center justify-center gap-2"
            >
              <BookOpen className="w-5 h-5" />
              {promptAnswered ? "View Today's Prompt" : "Answer Today's Prompt"}
            </button>

            <button
              onClick={() => setCurrentView('ai-persona')}
              className="flex-1 bg-white border-2 border-gray-200 text-gray-700 py-4 rounded-xl font-semibold hover:border-gray-300 transition-all flex items-center justify-center gap-2"
            >
              <Sparkles className="w-5 h-5" />
              Talk to My AI Persona
            </button>
