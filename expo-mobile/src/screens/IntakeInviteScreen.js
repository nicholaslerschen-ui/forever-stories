  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>
        Share your stories with the people who matter most. They'll be able to
        read your stories, chat with your AI persona, and submit questions for
        you to answer.
      </Text>

      <View style={styles.infoCard}>
        <Text style={styles.infoText}>
          They'll receive an invite code to create their account and connect with you. You can always invite more people later from your account settings.
        </Text>
      </View>
